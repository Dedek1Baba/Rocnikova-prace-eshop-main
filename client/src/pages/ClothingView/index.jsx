      ...
      <div className="flex items-center justify-center min-h-screen p-6 ">
        <div className="bg-white shadow-2xl rounded-3xl p-8 w-full max-w-xl flex flex-col gap-6">
          ...
          <div className="space-y-2 text-base text-gray-700">
            ...
            <p>
              <span className="font-semibold">Název:</span> {clothing.name}
            </p>
            <p>
            ...
            <p>
              <span className="font-semibold">Gramáž:</span> {clothing.gram}
            </p>
            <p>
              <span className="font-semibold">Doba dodání:</span>{" "}
              {clothing.delivery}
            </p>
            <p>
              <span className="font-semibold">Barva:</span> {clothing.color}
            </p>
            <p>
              <span className="font-semibold">Cena:</span> {clothing.price}
            </p>
            <p>
              <span className="font-semibold">Url Obrázku:</span>{" "}
              {clothing.image}
            </p>
          </div>
